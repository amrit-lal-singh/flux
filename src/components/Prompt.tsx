...
export function Prompt({
  ...
  const [isEditing, setIsEditing] = useState(
    onMainButtonClick = () => { if (promptNodeType === FluxNodeType.User) { submitPrompt(); if (MIXPANEL_TOKEN) mixpanel.track('Generate Response', { Temperature: settings.temp, 'No. of Responses': settings.n, 'Response Required': 'True' }); } else { newConnectedToSelectedNode(FluxNodeType.User); } };
  );
